...
BASE_CRAIGSLIST_URL = 'https://singapore.craigslist.org/search/?query={}'
...
def new_search(request):
    ...
    for post in post_listings:
        ...
        if post.find(class_='result-image').get('data-ids'):
            ...
            post_image_url = 'https://image.shutterstock.com/image-vector/no-image-available-icon-vector-260nw-1323742826.jpg'
